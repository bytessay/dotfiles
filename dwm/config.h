...
static const char *volumeup[] = { "cvolume", "up", NULL };
static const char *volumedown[] = { "cvolume", "down", NULL };
static const char *volumemute[] = { "cvolume", "mute", NULL };
...
static const Key keys[] = {
	...
	// { MODKEY,                       XK_Up,  tagmon,         {.i = -1 } },
	// { MODKEY,                       XK_Down, tagmon,         {.i = +1 } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
